...
docker exec "$container" sh -c 'command -v pdftotext >/dev/null'
docker exec "$container" sh -c 'command -v pdftoppm >/dev/null'
docker exec "$container" sh -c 'command -v pdfinfo >/dev/null'
